...
function baiduMap(contentId,pointX,pointY,mapTitle,mapContent){
    ...
    //鍒涘缓鍦板浘鍑芥暟锛�
    function createMap(){
        var map = new BMap.Map(contentId);//鍦ㄧ櫨搴﹀湴鍥惧鍣ㄤ腑鍒涘缓涓€涓湴鍥�
        var point = new BMap.Point(pointX,pointY);//瀹氫箟涓€涓腑蹇冪偣鍧愭爣
	...
	//var markerArr = [{title:"涓夊厓妗ヨ惀杩愪腑蹇�",content:"鍖椾含甯傛湞闃冲尯涓滀笁鐜寳璺垔2鍙峰浗闄呮腐D搴�1003瀹�",point:"116.465057|39.964355",isOpen:0,icon:{w:23,h:25,l:46,t:21,x:9,lb:12}}]
